...
from correspondencia.forms import LibroForm, MensajeriaForm
   ...
   # libros = Libro.objects.filter(fecha_entrada__range=['2023-04-05T00:00:00', '2023-04-05T13:00:00'],remitente_destinatario__istartswith= 'D')
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return generar_pdf(encabezado + data )           
    else:
        form = MensajeriaForm()
...
def generar_pdf(data):
    ...
    # Crear la tabla
    tabla = Table(data1_paragraphs, colWidths=[22,30,55,30,30,55,55,110,55,148.5,197], rowHeights=row_height)
